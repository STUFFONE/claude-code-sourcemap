...
function main() {
  ...
  const defaults = {
    ...
    CLAUDE_CODE_INTENT_ROUTER: 'smart',
    CLAUDE_CODE_PHASE_MACHINE: '1',
    CLAUDE_CODE_QUALITY_GATE: 'hard',
    CLAUDE_CODE_QUALITY_MIN_CREATIVE: '85',
    CLAUDE_CODE_QUALITY_MIN_RESEARCH: '85',
    CLAUDE_CODE_QUALITY_MIN_ENGINEERING: '90',
    CLAUDE_CODE_QUALITY_MIN_REMOTE: '90',
    CLAUDE_CODE_DELEGATION_POLICY: 'proactive',
    CLAUDE_CODE_TOOL_REGISTRY: '1',
    CLAUDE_CODE_CREATIVE_GATE: '1',
    CLAUDE_CODE_RESEARCH_GATE: '1',
    CLAUDE_CODE_ENGINEERING_GATE: '1',
    CLAUDE_CODE_CHAT_GATE: '0',
    CLAUDE_CODE_LOCAL_STATUS_WEB: '0',
    CLAUDE_CODE_PROJECT_MEMORY_SCOPE: 'project',
  }
  for (const name of [
    ...
    'CLAUDE_CODE_INTENT_ROUTER',
    'CLAUDE_CODE_PHASE_MACHINE',
    'CLAUDE_CODE_QUALITY_GATE',
    'CLAUDE_CODE_QUALITY_MIN_CREATIVE',
    'CLAUDE_CODE_QUALITY_MIN_RESEARCH',
    'CLAUDE_CODE_QUALITY_MIN_ENGINEERING',
    'CLAUDE_CODE_QUALITY_MIN_REMOTE',
    'CLAUDE_CODE_DELEGATION_POLICY',
    'CLAUDE_CODE_TOOL_REGISTRY',
    'CLAUDE_CODE_CREATIVE_GATE',
    'CLAUDE_CODE_RESEARCH_GATE',
    'CLAUDE_CODE_ENGINEERING_GATE',
    'CLAUDE_CODE_CHAT_GATE',
    'CLAUDE_CODE_LOCAL_STATUS_WEB',
    'CLAUDE_CODE_PROJECT_MEMORY_SCOPE',
    'ANTHROPIC_BASE_URL',
    'ANTHROPIC_MODEL',
